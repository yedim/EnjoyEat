...
<section class="grid-container" style="margin-top:140px;margin-bottom:100px;">
	 ...
	 <article class="grid-item">
	  ...
	  <article class="grid-item">
	    ...
	    <div class="grid">
	      <div class="grid-star-review"><img src="star.png">4.5</div>
	      <div class="grid-title"  onclick="goToDetail('하루초밥');">7위  하루초밥</div>
	      <div >초밥/피자/새우장</div>
	      <div >묵동, 회/스시</div>
	    </div>
	  </article>
	   <article class="grid-item">
	    ...
	    <div class="grid">
	      <div class="grid-star-review"><img src="star.png">4.5</div>
	      <div class="grid-title" onclick="goToDetail('라떼플로라');">8위  라떼플로라</div>
	      <div >꽃/커피/생초콜릿</div>
	      <div >묵동, 카페</div>
	    </div>
	  </article> <article class="grid-item">
	    ...
	    <div class="grid">
	      <div class="grid-star-review"><img src="star.png">4.5</div>
	      <div class="grid-title" onclick="goToDetail('명량핫도그');">9위  명량핫도그</div>
	      <div>핫도그</div>
	      <div>신내동, 빵</div>
	    </div>
	  </article>
